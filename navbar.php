...
<ul id="slide-out" class="sidenav">
        ...
        <div class="user-view">
            ...
            <span class="white-text email "><?php echo $_SESSION['correo']."<br>";
                    if($_SESSION['id_tipo_empleado'] ==1){
                        echo "Administrador";
                        }elseif($_SESSION['id_tipo_empleado'] ==2){
                            echo "Contador";
                            }elseif($_SESSION['id_tipo_empleado'] ==3){
                                echo "Vendedor";
                            }elseif($_SESSION['id_tipo_empleado'] ==4){
                                echo "Bodeguero";
                            } echo " -- ";
                    if($_SESSION['id_sucursal'] ==1){
                        echo "Retalhuleu";
                    }elseif($_SESSION['id_sucursal'] ==2){
                        echo "Mazatenango";
                    }elseif($_SESSION['id_sucursal'] ==3){
                        echo "Coatepeque";
                    }
                ?>
            </span>
    ...
    <div name="admin">
        ...
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-empleados">Empleados<i class="material-icons">person</i></a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-clientes">Clientes<i class="material-icons">person</i></a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-proveedores">Proveedores<i class="material-icons">person</i></a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-perfil">Perfil<i class="material-icons">settings</i></a></li>
        ...
        <ul id='dropdown-proveedores' class='dropdown-content'>
            <li><a href="factura.php"><i class="material-icons">person</i>Proveedores</a></li>
    ...
    <div name="bodeguero">
        ...
        <li><a href="/punto-venta-master/"><i class="material-icons">home</i>Inicio</a></li>
        <li><a href="compras.php"><i class="material-icons">shopping_cart</i>Comprar</a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-clientes">Proveedores<i class="material-icons">person</i></a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown-perfil">Perfil<i class="material-icons">settings</i></a></li>
